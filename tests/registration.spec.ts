...
test.describe("Регистрация пользователя", () => {
  ...
  test("TC-REGRESSION-05: Невалидный email", async () => {
  ...
  test("TC-REGRESSION-06: Email не заполнен", async () => {
  ...
  test("TC-REGRESSION-07: Имя не заполнено", async () => {
  ...
  test("TC-REGRESSION-08: Фамилия не заполнена", async () => {
  ...
  test("TC-REGRESSION-09: Пароль не заполнен", async () => {
  ...
  test("TC-REGRESSION-10: Пароль не совпадает", async () => {
    const user = new UserBuilder().build();
  ...
  test("TC-REGRESSION-11: Пароль не проходит по длине", async () => {
