...
test.skip('TC-REGRESSION-03: Поиск товара ', async ({ page }) => {
  const products = ['Custom T-Shirt', '14.1-inch Laptop', 'Camcorder'];
  ...
  await expect(page.locator(`//a[text()="${productName}"]`)).toBeVisible();
});
